...
AYigsoftSampleCharacter::AYigsoftSampleCharacter()
{
...
void AYigsoftSampleCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AYigsoftSampleCharacter::Look);
	}
	else
	{
...
void AYigsoftSampleCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AYigsoftSampleCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
